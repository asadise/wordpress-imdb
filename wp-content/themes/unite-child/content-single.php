...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">
		...
		<br/>
		<?php if($post->post_type == "films") {?>
			<hr/>
			<b>Release Date:</b> <?php echo get_post_meta(get_the_ID(), 'Release Date', TRUE);?>
			<br/>
			<b>Ticket Price:</b> <?php echo get_post_meta(get_the_ID(), 'Ticket Price', TRUE);?>
			<hr/>,
			<b>Country:</b> <ul><?php echo get_the_term_list( $post->ID, 'Country', '<li>', ', ', '</li>' ) ?></ul>
			<b>Genre:</b> <ul><?php echo get_the_term_list( $post->ID, 'Genre', '<li>', ', ', '</li>' ) ?></ul>
		<?php } ?>
